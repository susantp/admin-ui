...
import {LoginBoxProps} from "@/auth/type/login-box-props";
import {LoginHeaderProps} from "@/auth/interface/login-header-props";
import {LoginWrapperProps} from "@/auth/interface/login-wrapper-props";
...
export const LoginBox = ({children}: LoginBoxProps): JSX.Element => {
  return <div
    className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">{children}</div>
}
export const LoginHeader = ({registerLink}: LoginHeaderProps): JSX.Element => {
  return <div id={`login-header`} className="login-header">
    <Image className="mx-auto h-8 w-auto" src="/lis.png" alt="Your Company" width={195} height={32} />
    <h2
      className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-800">
      SOA-POC
    </h2>
...
export const SocialLogin = (): JSX.Element => {
  return <div id={`social-login`} className="mt-6">
...
export const LoginForm = (): JSX.Element => {
  return <form id={`login-form`} className="space-y-6" action="#" method="POST">
    <div>
      <label
        htmlFor="email"
