...
interface ISidebarDesktopActions {
  ...
  getIcon: (keyName: keyof IconSet, additionalClass?: string) => JSX.Element | null
}
...
const useSidebarDesktopActions = (): ISidebarDesktopActions => {
  ...
  const getIcon = (keyName: keyof IconSet, additionalClass?: string): JSX.Element | null => {
  ...
  return {
    screens, handleNavigation, getIcon
  }
}
