...
export default function NavAnchor({screen,}: INavigationAnchorProps): JSX.Element {
  return (
    <a
      key={screen.name}
      href={screen.name.toLowerCase()}
      className={ "group flex items-center px-2 py-2 text-base font-medium rounded-md text-teal-100 hover:bg-teal-600"
