...
import InfoBox from "@/src/modules/dashboard/presentation/components/dashboard-components/info-box"
import MostViewedWrapper from "@/src/modules/dashboard/presentation/components/dashboard-components/most-viewed-wrapper"
import Section from "@/src/modules/dashboard/presentation/components/dashboard-components/section"
import PocContainer from "@/src/modules/dashboard/presentation/components/poc-container"
...
export default function DashboardContainer(): JSX.Element {
  ...
  return (
    <PocContainer>
      <Section label="Most viewed pages" subLabel={null} actionEl={null}>
        <MostViewedWrapper>
      ...
      <Section label="Active UserContainer" subLabel={null} actionEl={null}>
        <PocTableWrapper>
          <PocTableTools />
